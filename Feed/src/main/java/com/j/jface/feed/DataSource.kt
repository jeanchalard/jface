  ...
  companion object {
    private val J_SOURCES = arrayOf(
     DataSource(Const.日比谷線_北千住_平日,
      "https://ekitan.com/timetable/railway/line-station/273-0/d1?view=list&dw=0", EkitanParser::class.java, 1),
     DataSource(Const.日比谷線_北千住_土曜,
      "https://ekitan.com/timetable/railway/line-station/273-0/d1?view=list&dw=1", EkitanParser::class.java, 1),
     DataSource(Const.日比谷線_北千住_日曜,
      "https://ekitan.com/timetable/railway/line-station/273-0/d1?view=list&dw=2", EkitanParser::class.java, 1),
     DataSource(Const.日比谷線_六本木_平日,
    "https://ekitan.com/timetable/railway/line-station/273-17/d1?view=list&dw=0", EkitanParser::class.java, 1),
     DataSource(Const.日比谷線_六本木_土曜,
      "https://ekitan.com/timetable/railway/line-station/273-17/d1?view=list&dw=1", EkitanParser::class.java, 1),
     DataSource(Const.日比谷線_六本木_日曜,
      "https://ekitan.com/timetable/railway/line-station/273-17/d1?view=list&dw=2", EkitanParser::class.java, 1),
