...
public class Fences
{
  ...
  private static final Params 立石 = new Params(Const.立石_FENCE_NAME, 35.7424501, 139.8418709, 2000);
  private static final Params 三ノ輪 = new Params(Const.三ノ輪_FENCE_NAME, 35.7297397, 139.7911664, 600);
