...
public class Fences
{
  ...
  public static final Params HOME = new Params("home", 35.7466148, 139.7996878, 1000);
  // For work 400m is enough.
  public static final Params WORK = new Params("work", 35.6607004, 139.7291515, 400);
  // For Nippori we want info when heading there, so 2~2.5km should be fine so as not to encroach on home.
  public static final Params NIPPORI = new Params("nippori", 35.7278246, 139.7715682, 2000);
